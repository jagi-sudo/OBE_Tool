    ...
    <div id="wrapper">
      ...
      <?php if($_SESSION['desgn']==3){?>
                  ...
                  <?}?>
                    ...
                    <a class="nav-link" href="MarksCOMapping.php" style="color: #007bff;font-weight: bold;">Marks-CO Mapping</a>
          ...
          <table class="b">
            ...
            <tbody>
              <tr >
                ...
                <td><select class="form-control custom-select" name="1a" style="width:50px;">
              ...
              <td><select class="form-control custom-select" name="1b"style="width:50px;">
              <option selected>1</option>
              <option>2</option>
              <option>3</option>
              <option>4</option>
              ...
              <td><select  class="form-control custom-select" name="1c"style="width:50px;">
              <option selected>1</option>
              <option>2</option>
              <option>3</option>
              <option>4</option>
              ...
              <td><select  class="form-control custom-select" name="1d"style="width:50px;">
              <option selected>1</option>
              <option>2</option>
              <option>3</option>
              <option>4</option>
              ...
              <td><select  class="form-control custom-select" name="1e"style="width:50px;">
              <option selected>1</option>
              <option>2</option>
              <option>3</option>
              <option>4</option>
              ...
              <td><select  class="form-control custom-select" name="1f"style="width:50px;">
              <option selected>1</option>
              <option>2</option>
              <option>3</option>
              <option>4</option>
              ...
              <td><select  class="form-control custom-select" name="2a"style="width:50px;">
              <option selected>1</option>
              <option>2</option>
              <option>3</option>
              <option>4</option>
              ...
              <td><select  class="form-control custom-select" name="2b"style="width:50px;">
              <option selected>1</option>
              <option>2</option>
              <option>3</option>
              <option>4</option>
              ...
              <td><select  class="form-control custom-select" name="3a"style="width:50px;">
              <option selected>1</option>
              <option>2</option>
              <option>3</option>
              <option>4</option>
              ...
              <td><select  class="form-control custom-select" name="3b"style="width:50px;">
              <option selected>1</option>
              <option>2</option>
              <option>3</option>
              <option>4</option>
...
if(isset($_POST['map_final'])){
  ...
  $dash_query = "UPDATE `dash_data` SET `marks_map`= 1  
